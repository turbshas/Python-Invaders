...
BARRIER_SPRITES = [
	'python invaders images\\barrier_stage0.png',
	'python invaders images\\barrier_stage1.png',
	'python invaders images\\barrier_stage2.png',
	'python invaders images\\barrier_stage3.png'
]
